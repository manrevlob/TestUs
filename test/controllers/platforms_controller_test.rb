...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference('Platform.count') do
      post platforms_url, params: { platform: { description: @platform.description, name: @platform.name } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { description: @platform.description, name: @platform.name } }
