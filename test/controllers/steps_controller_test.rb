...
class StepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create step" do
    assert_difference('Step.count') do
      post steps_url, params: { step: { action: @step.action, expectedResult: @step.expectedResult } }
    end
  ...
  test "should update step" do
    patch step_url(@step), params: { step: { action: @step.action, expectedResult: @step.expectedResult } }
