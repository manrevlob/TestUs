...
case_plans = CasePlan.create([
    # {:case_id => Case.find_by(title:"Registro").id, :plan_id => Plan.find_by(name:"Registro").id, :user_id => User.find_by(surname:"Senior").id},
    # {:case_id => Case.find_by(title:"Login").id, :plan_id => Plan.find_by(name:"Login").id, :user_id => User.find_by(surname:"Junior").id}
                             ])
